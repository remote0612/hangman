...
Original file is located at
    https://colab.research.google.com/drive/1iElkKSmSBcQrLiuW-bSxGJh3GqVNzKAP
"""
...
class Hangman():
    ...
    def is_invalid_letter(self, input_):
        ...
        """
        return (not input_.isalpha()) or (input_.isalpha() and len(input_)>1)
    ...
    def play(self):
        ...
        while True:
            ...
            if user_input in self.game_progress:
                print('이미 입력했습니다')# 이미 입력받았던 알파벳이면, 이미 입력했다 메시지 출력
